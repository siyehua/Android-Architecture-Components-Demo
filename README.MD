...
至此,即可解决 MVP 内存泄漏的问题,详细代码可看项目中的 [mvp](./app/src/main/java/com/example/siyehua/myanotation/mvp) 目录代码.
...
关于代码的详细请看项目中的 [lifecycle](./app/src/main/java/com/example/siyehua/myanotation/lifecycle) 目录下的实现.
